...
function dkx_master_gtm_id() { return defined( 'DKX_GTM_ID' ) ? DKX_GTM_ID : trim( (string) get_option( 'dkx_master_gtm_id', 'GTM-5HGZF88' ) ); }
function dkx_master_ga4_id() { return defined( 'DKX_GA4_ID' ) ? DKX_GA4_ID : trim( (string) get_option( 'dkx_master_ga4_id', 'G-12L3V59BQL' ) ); }
