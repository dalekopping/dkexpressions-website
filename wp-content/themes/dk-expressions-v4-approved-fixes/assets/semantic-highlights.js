(function () {
	...
	var continents = ['Africa','Asia','Europe','North America','South America','Antarctica','Australia','Oceania','African','Asian','European','North American','South American','Antarctic','Australian','Oceanian'];
	...
	var locations = southAfricanPlaces.concat(continents, countries, config.additionalLocations || []).filter(Boolean);
